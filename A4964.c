...
// Gate
    ...
    // n = 0~15 ,The range of IR1/IF1 is –5(5) mA to –75(75) mA. 0 will set the gate drive to switch mode
    // input range : 0 ~ 75 , 0 : switch mode
    //------------------------------------------
    // IR2[3:0](b4-b1) Turn-On Current 2
    // n = 0~15 ,The range of IR2(IF2) is –5(5) mA to –75(75) mA. 0 will set the gate drive to switch mode
    // input range : 0 ~ 75 , 0 : switch mode
...
// Ramping
    ...
    //------------------------------------------------------
    // -- PHASE ADVANCE
    // n = 0 ~ 63 , The range of θADV is 0 to 43.4° and 60°
    // input range : 0 ~ 600
    //------------------------------------------------------
...
// tPW = –0.2 μs – (n × 0.2 μs)
// n = 0~7 ,The range of t?PW is –0.2 us to –1.6 us
//------------------------------------------
...
// IR1 = n × –5 mA
// n = 0~15 ,The range of IR1 is –5 mA to –75 mA. 0 will set the gate drive to switch mode
//------------------------------------------
// IR2[3:0](b4-b1) Turn-On Current 2
// IR1 = n × –5 mA
// n = 0~15 ,The range of IR1 is –5 mA to –75 mA. 0 will set the gate drive to switch mode
...
// θBW = 60°(elec)            |n=31
// n = 0~31 , The range of θBW is 1.4° to 43.4° and 60°.
// input range: 0 ~ 600
//----------------------------------------------
// return : 
// 1: write success
